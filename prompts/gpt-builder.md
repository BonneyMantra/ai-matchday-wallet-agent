...
- The AI agent must perform or prepare a real wallet-signed/on-chain action. If no funded signer is available, implement the signing/deployment code, local/anvil proof, X Layer RPC smoke checks, and ask Gabriel for a funded deployer/private key or approved wallet path. Do not present a chatbot-only flow as complete.
- Test fixtures are allowed only inside tests or seed scripts and must be labeled as tests/fixtures in UI, README, TRUTH_AUDIT.md, and QUALITY_GATE.md.
- Team assignment: Bonney, JoelOffBeat, DarthStormer. Primary repo owner should be Bonney unless browser preflight proves another assigned account is better.

Hackathon: X Layer X Cup Hackathon 2026
Idea: AI Matchday Wallet Agent
Execution workspace: /Users/gabrielantonyxaviour/Documents/hackathons/x-layer-x-cup-hackathon-2026/execution/2026-05-22T01-33-56Z-ai-matchday-wallet-agent
Report output: /Users/gabrielantonyxaviour/Documents/hackathons/x-layer-x-cup-hackathon-2026/execution/2026-05-22T01-33-56Z-ai-matchday-wallet-agent/outputs/builder-report.md
